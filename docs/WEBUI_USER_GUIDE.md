...
- Identity: “PhoneAgent, a customizable AI phone representative.”
...
Changing the task should not silently change the package identity. Changing the voice should not change the
...
**Use:** Be specific and truthful, for example “AI support advisor at Example Company.” Never
...
**Use:** Keep it short and direct, for example: “I'm Nova, an AI phone representative.”
...
a configured product, supporting a customer or booking an appointment.
...
**What:** A machine-friendly identifier such as `catalog_sales`.
...
**Use:** Use a clear business title such as “French Product Consultation.”
