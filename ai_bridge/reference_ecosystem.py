...
retail sales, appointment booking, technical support, and medical triage.
"""
...
def get_reference_package(domain: str) -> AgentPackageV1:
    ...
    configs = {
        "retail_sales": ("retail_sales", "Retail Sales Agent", "Sales", "Present verified catalog offers and guide suitable orders."),
